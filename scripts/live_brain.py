"""CubeMind v3 Live Brain Demo — webcam + audio + keyboard teaching.
...
def draw_overlay(frame: np.ndarray, result: dict, brain: CubeMindV3) -> np.ndarray:
    ...
    # Title
    cv2.putText(frame, "CubeMind v3 Brain", (x0, y), font, 0.6, cyan, 2)
    y += dy + 5
...
def main():
    parser = argparse.ArgumentParser(description="CubeMind v3 Live Brain")
    ...
    # Init brain
    print("Initializing CubeMind v3 brain...")
    brain = CubeMindV3(
    ...
    while True:
        ...
        cv2.imshow("CubeMind v3 Brain", display)
